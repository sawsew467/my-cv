          ...
          <div className="flex sm:flex-row flex-col w-full items-center">
            ...
            <div className="flex flex-col sm:w-[70%] w-full sm:pl-8 ml-0">
              ...
              <p className="text-lg sm:text-start text-center">
                ...
                experience with many real projects, I promise to give you the
                best web design. I provide web design services, convert the
                design to code. If my services are suitable for you, please
                contact me!
              </p>
              <div className="mt-8 w-40 h-12 relative mx-auto sm:mx-0">
                ...
                <div className="w-full h-full absolute top-0 left-0 border-2 z-[-1] border-[#121e27]">
